...
export const fetchCity = (cityName, unit = 'Imperial') => {
	// forecast 5d/3h
	const forecastURL = `${WEATHER_URL}/forecast?APPID=${OpenWeatherMap_Key}&q=${cityName}&units=${unit}`;
	// get current weather
	const currentURL = `${WEATHER_URL}/weather?APPID=${OpenWeatherMap_Key}&q=${cityName}&units=${unit}`;

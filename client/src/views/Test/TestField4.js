	...
	render () {
		return (
				<svg className={ style.svgMainSpinner } version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
					...
					<svg className={ style.g1 } version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
					     xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		C77.1,73.5,77.9,74.3,77.9,75.2z"/>
		 ...
		 M69.8,57c0,4-3.2,7.2-7.3,7.2c-4,0-7.2-3.2-7.2-7.2c0-4,3.2-7.3,7.2-7.3C66.5,49.7,69.8,53,69.8,57z"/>
							...
							<path className="st0" d="M59.8,57c0,1.5,1.2,2.7,2.7,2.7c1.5,0,2.7-1.2,2.7-2.7c0-1.5-1.2-2.7-2.7-2.7C61,54.2,59.8,55.5,59.8,57z"/>
						</g>
					</svg>
				</svg>
		);

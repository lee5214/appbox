				...
				<Row>
					<Col xs="12" md="6">
						<Card>
							...
							<CardBody>
								<Form action="" method="post" encType="multipart/form-data" className="form-horizontal">
									...
									<FormGroup row hidden>
										<Col md="3">
											<Label className="custom-file" htmlFor="file-input">Custom file
												input</Label>
										</Col>
										<Col xs="12" md="9">
											<Label className="custom-file">
												<Input className="custom-file" type="file" id="file-input"
												       name="file-input"/>
							...
							<CardFooter>
								<Button type="submit" size="sm" color="primary"><i className="fa fa-dot-circle-o"></i>
									Submit</Button>
								<Button type="reset" size="sm" color="danger"><i className="fa fa-ban"></i>
									Reset</Button>
							</CardFooter>
						</Card>
						<Card>
					...
					<Col xs="12" md="6">
						...
						<Card>
							...
							<CardFooter>
								<Button type="submit" size="sm" color="primary"><i className="fa fa-user"></i>
									Login</Button>
								<Button type="reset" size="sm" color="danger"><i className="fa fa-ban"></i>
									Reset</Button>
							</CardFooter>
							...
							<CardBody>
								<Form action="" method="post" className="form-horizontal">
									<FormGroup row>
										...
										<Col sm="6">
											<Input size="sm" type="text" id="input-small" name="input-small"
											       className="input-sm"
									...
									<FormGroup row>
										...
										<Col sm="6">
											<Input size="lg" type="text" id="input-large" name="input-large"
											       className="input-lg"
				...
				<Row>
					<Col xs="12" md="4">
						<Card>
							...
							<CardFooter>
								<Button type="submit" size="sm" color="success"><i className="fa fa-dot-circle-o"></i>
									Submit</Button>
								<Button type="reset" size="sm" color="danger"><i className="fa fa-ban"></i>
									Reset</Button>
							</CardFooter>
								...
								<Form action="" method="post" className="form-horizontal">
									<FormGroup row>
										<Col md="12">
											<InputGroup>
												<InputGroupButton>
													<Button color="primary"><i className="fa fa-search"></i>
														Search</Button>
												</InputGroupButton>
						...
						<Card>
							<CardHeader>
								...
								<div className="card-actions">
									<a className="btn-setting"><i className="icon-settings"></i></a>
									<a className="btn-minimize"><i className="icon-arrow-up"></i></a>
									<a className="btn-close"><i className="icon-close"></i></a>
								</div>
							</CardHeader>
							<CardBody>
								<Form className="form-horizontal">

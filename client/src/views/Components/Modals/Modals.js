						...
						<Card>
							...
							<CardBody>
								...
								<Modal isOpen={ this.state.large } toggle={ this.toggleLarge }
									...
									<ModalFooter>
										<Button color="primary" onClick={ this.toggleLarge }>Do
											Something</Button>{ ' ' }
								...
								<Modal isOpen={ this.state.small } toggle={ this.toggleSmall }
									...
									<ModalFooter>
										<Button color="primary" onClick={ this.toggleSmall }>Do
											Something</Button>{ ' ' }
								...
								<Modal isOpen={ this.state.primary } toggle={ this.togglePrimary }
									...
									<ModalFooter>
										<Button color="primary" onClick={ this.togglePrimary }>Do
											Something</Button>{ ' ' }
								...
								<Modal isOpen={ this.state.success } toggle={ this.toggleSuccess }
									...
									<ModalFooter>
										<Button color="success" onClick={ this.toggleSuccess }>Do
											Something</Button>{ ' ' }
								...
								<Modal isOpen={ this.state.warning } toggle={ this.toggleWarning }
									...
									<ModalFooter>
										<Button color="warning" onClick={ this.toggleWarning }>Do
											Something</Button>{ ' ' }
								...
								<Modal isOpen={ this.state.danger } toggle={ this.toggleDanger }
									...
									<ModalFooter>
										<Button color="danger" onClick={ this.toggleDanger }>Do
											Something</Button>{ ' ' }

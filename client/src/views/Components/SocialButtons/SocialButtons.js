					...
					<Col xs="12">
						<Card>
							<CardHeader>
								...
								<code style={ {textTransform : 'lowercase'} }>&lt;button
									className="btn-facebook"&gt;&lt;span&gt;
					...
					<Col xs="12">
						<Card>
							<CardHeader>
								...
								<code style={ {textTransform : 'lowercase'} }>&lt;button className="btn-facebook
									icon"&gt;&lt;span&gt;
									Facebook&lt;/span&gt;&lt;/Button&gt;</code>
							</CardHeader>
							<CardBody>
								...
								<p>
									...
									<Button size="sm"
									        className="btn-stack-overflow icon"><span>StackOverflow</span></Button>
						...
						<Card>
							...
							<CardBody>
								...
								<p>
									...
									<Button size="sm"
									        className="btn-stack-overflow text"><span>StackOverflow</span></Button>

								...
								<Row>
									...
									<Col sm="7" className="d-none d-sm-inline-block">
										...
										<ButtonToolbar className="float-right" aria-label="Toolbar with button groups">
											<ButtonGroup className="mr-3" data-toggle="buttons"
												...
												<Label htmlFor="option2" className="btn btn-outline-secondary active">
													<Input type="radio" name="options" id="option2" defaultChecked/>
													Month
												</Label>
												...
												<div className="callout callout-info">
													...
													<div className="chart-wrapper">
														<Line data={ makeSparkLineData (0, brandPrimary) }
														      options={ sparklineChartOpts } width={ 100 }
														      height={ 30 }/>
													</div>
												</div>
											</Col>
										...
										<ul className="horizontal-bars type-2">
											...
											<li className="divider text-center">
												<Button color="link" size="sm" className="text-muted"
													...
													<i className="icon-options"></i></Button>
											</li>
										</ul>
									</Col>
									<Col xs="12" xl="4">
										<Row>
											...
											<Col sm="6">
												<div className="callout callout-primary">
													...
													<div className="chart-wrapper">
														<Line data={ makeSparkLineData (5, brandPrimary) }
														      options={ sparklineChartOpts } width={ 100 }
														      height={ 30 }/>
													</div>
												</div>
											...
											<li>
												...
												<div className="actions">
													<Button color="link" className="text-muted">
														<i className="icon-settings"></i></Button>
												</div>
											</li>
											<li>
								...
								<Table hover responsive className="table-outline mb-0 d-none d-sm-table">
									...
									<tbody>
										<tr>
											...
											<td className="text-center">
												<img src={ 'img/flags/USA.png' } alt="USA"
												     style={ {height : 24 + 'px'} }/>
											</td>
											<td>
												<div className="clearfix">
													...
													<div className="float-right">
														<small className="text-muted">Jun 11, 2015 - Jul 10, 2015
														</small>
													</div>
												</div>
										...
										<tr>
											...
											<td className="text-center">
												<img src={ 'img/flags/Brazil.png' } alt="Brazil"
												     style={ {height : 24 + 'px'} }/>
											</td>
											<td>
												<div className="clearfix">
										...
										<tr>
											...
											<td className="text-center">
												<img src={ 'img/flags/India.png' } alt="India"
												     style={ {height : 24 + 'px'} }/>
											</td>
											<td>
												<div className="clearfix">
										...
										<tr>
											...
											<td className="text-center">
												<img src={ 'img/flags/France.png' } alt="France"
												     style={ {height : 24 + 'px'} }/>
											</td>
											<td>
												<div className="clearfix">
										...
										<tr>
											...
											<td className="text-center">
												<img src={ 'img/flags/Poland.png' } alt="Poland"
												     style={ {height : 24 + 'px'} }/>
											</td>
											<td>
												<div className="clearfix">

...
class GraphCircle extends Component {
	...
	render () {
		...
		M1.3,4.3c0-1,0.8-1.7,1.7-1.7c0.9,0,1.7,0.8,1.7,1.7C4.7,5.3,3.9,6,3,6C2.1,6,1.3,5.3,1.3,4.3z"/>
						<polygon style={{fill:'red'}} className="st0" points="26,0.6 26,3 74.7,3 74.7,9.9 79.2,9.9 79.2,0.6 	"/>
		...
		M9.4,22.5c0-4,3.2-7.2,7.3-7.2c4,0,7.2,3.2,7.2,7.2s-3.2,7.3-7.2,7.3C12.7,29.8,9.4,26.6,9.4,22.5z"/>
						...
						<polygon style={{fill:'red'}}  className="st0" points="0.3,38.8 0.3,79.5 13.3,79.5 13.3,73.5 4.4,73.5 4.4,38.8 	"/>
		...
		C77.1,73.5,77.9,74.3,77.9,75.2z"/>
						<polygon style={{fill:'red'}} className="st0" points="53.2,78.9 53.2,76.6 4.5,76.6 4.5,69.6 0,69.6 0,78.9 	"/>
		 ...
		 M69.8,57c0,4-3.2,7.2-7.3,7.2c-4,0-7.2-3.2-7.2-7.2c0-4,3.2-7.3,7.2-7.3C66.5,49.7,69.8,53,69.8,57z"/>
						...
						<polygon style={{fill:'red'}} className="st0" points="78.9,40.7 78.9,0 65.9,0 65.9,6 74.7,6 74.7,40.7 	"/>
						<path className="st0"

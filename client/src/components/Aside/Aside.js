    ...
    return (
      <aside className="aside-menu">
        ...
        <TabContent className={"d-flex"} activeTab={this.state.activeTab}>
          <TabPane
            tabId="1"
            className={`p-3 ${mode === "3D" ? "align-self-center" : null}`}
          >
            ...
            <div className="aside-options mode3D-blur">
              ...
              <div>
                <small className="text-muted">
                  For mouse tracking function, it will change user view based on
                  cursor position, I implemented from my old website and tweeked
                  a little for performance.
                </small>
              </div>
            </div>
            ...
            <div className="aside-options mode3D-blur">
              <div className="clearfix mt-3">
                ...
                <Label
                  for="cameraFixed-button"
                  className="switch switch-text switch-pill switch-success switch-sm float-right"
                >
                  <Input
                    id="cameraFixed-button"
                    type="checkbox"
                    className="switch-input"
...
*/}
            <div className="text-uppercase mb-1 mt-2">
              <a href={"/api/current_user"} target={"_blank"}>
                client info
              </a>
            </div>
            <div className="text-uppercase mb-1 mt-2">
              <a href={"/api/clientLog"} target={"_blank"}>
                client log
              </a>
            </div>
          </TabPane>
          ...
          >
            ...
            <div className="callout callout-warning m-0 py-3">
              ...
              <small className="text-muted mr-3 text-bold">
                <i className="fa fa-code mr-2 text-white" />
                <a href={"https://blog.cong-li.com"} target={"_blank"}>
                  blog
                </a>
              </small>
              <br />
              <small className="text-muted mr-3 text-bold">
                <i className="fa fa-google mr-2 text-white" />
                <a
                  href={
                    "https://groups.google.com/a/cong-li.com/forum/#!forum/discuss"
                  }
                  target={"_blank"}
                >
                  google group
              ...
              <br />
              <small className="text-muted mr-3 bold">
                <i className="fa fa-envelope mr-2 text-white" />
            ...
            <div className="callout callout-danger m-0 py-3">
              ...
              <small className="text-muted mr-3">
                <i className="icon-calendar" />&nbsp; total:{" "}
                {this.state.allGoogleUsers.length} users
              </small>
            ...
            <div className="callout callout-danger m-0 py-3">
              <div>
                <strong> Facebook Users</strong>
              </div>
              <small className="text-muted mr-3">
                <i className="icon-calendar" />&nbsp; total:{" "}
                {this.state.allFacebookUsers.length} users
              </small>
              <div className="avatars-stack mt-2">
